...
def main():
    ...
    try:
        while True:
            ...
            if message[0] != "/":
                users.execute("INSERT INTO messages (sender, message, receiver) VALUES (%s, %s, %s)", (sender, message, "ALL"))
                users_db.commit()
                continue
            ...
            if command[0] in ["/quit", "/q"]:
                ...
                users.execute("INSERT INTO messages (sender, message, receiver) VALUES (%s, %s, %s)", (sender, dm_message, receiver))
                users_db.commit()
